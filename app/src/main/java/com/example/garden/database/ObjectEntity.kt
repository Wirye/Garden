...
sealed interface Genre : GridGenreItem {
    @Parcelize @Serializable data object Drama : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Drama; @IgnoredOnParcel
    override val colorHex = "#37619F" }
    @Parcelize @Serializable data object Comedy : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Comedy; @IgnoredOnParcel
    override val colorHex = "#FFD600" }
    @Parcelize @Serializable data object Romance : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Romance; @IgnoredOnParcel
    override val colorHex = "#FF85A2" }
    @Parcelize @Serializable data object EverydayLife : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.EverydayLife; @IgnoredOnParcel
    override val colorHex = "#A0E4B0" }
    @Parcelize @Serializable data object School : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.School; @IgnoredOnParcel
    override val colorHex = "#A0E4B0" }
    @Parcelize @Serializable data object Psychological : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Psychological; @IgnoredOnParcel
    override val colorHex = "#9D5CFF" }
    @Parcelize @Serializable data object Shonen : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Shonen; @IgnoredOnParcel
    override val colorHex = "#FF9100" }
    @Parcelize @Serializable data object ActionMovie : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.ActionMovie; @IgnoredOnParcel
    override val colorHex = "#FF4B4B" }
    @Parcelize @Serializable data object MartialArts : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.MartialArts; @IgnoredOnParcel
    override val colorHex = "#FF4B4B" }
    @Parcelize @Serializable data object Action : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Action; @IgnoredOnParcel
    override val colorHex = "#FF4B4B" }
    @Parcelize @Serializable data object Adventures : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Adventures; @IgnoredOnParcel
    override val colorHex = "#4CAF50" }
    @Parcelize @Serializable data object Shoujo : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Shoujo; @IgnoredOnParcel
    override val colorHex = "#F48FB1" }
    @Parcelize @Serializable data object Fantasy : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Fantasy; @IgnoredOnParcel
    override val colorHex = "#1FA2FF" }
    @Parcelize @Serializable data object Isekai : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Isekai; @IgnoredOnParcel
    override val colorHex = "#00E5FF" }
    @Parcelize @Serializable data object ScienceFiction : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.ScienceFiction; @IgnoredOnParcel
    override val colorHex = "#2979FF" }
    @Parcelize @Serializable data object Cyberpunk : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Cyberpunk; @IgnoredOnParcel
    override val colorHex = "#2979FF" }
    @Parcelize @Serializable data object Fantastic : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Fantastic; @IgnoredOnParcel
    override val colorHex = "#2979FF" }
    @Parcelize @Serializable data object Supernatural : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Supernatural; @IgnoredOnParcel
    override val colorHex = "#2979FF" }
    @Parcelize @Serializable data object PostApocalypse : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.PostApocalypse; @IgnoredOnParcel
    override val colorHex = "#8D6E63" }
    @Parcelize @Serializable data object Detective : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Detective; @IgnoredOnParcel
    override val colorHex = "#BDBDBD" }
    @Parcelize @Serializable data object Thriller : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Thriller; @IgnoredOnParcel
    override val colorHex = "#D32F2F" }
    @Parcelize @Serializable data object Horrors : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Horrors; @IgnoredOnParcel
    override val colorHex = "#D32F2F" }
    @Parcelize @Serializable data object Mysticism : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Mysticism; @IgnoredOnParcel
    override val colorHex = "#7E57C2" }
    @Parcelize @Serializable data object Etty : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Etty; @IgnoredOnParcel
    override val colorHex = "#F06292" }
    @Parcelize @Serializable data object Harem : Genre { @IgnoredOnParcel
    override val displayNameId = R.string.Harem; @IgnoredOnParcel
...
sealed interface YearSezon : YearSezonInterface {
    @Parcelize @Serializable data object WINTER : YearSezon { @IgnoredOnParcel
    override val displayNameId = R.string.Winter }
    @Parcelize @Serializable data object SUMMER : YearSezon { @IgnoredOnParcel
    override val displayNameId = R.string.Summer }
    @Parcelize @Serializable data object SPRING : YearSezon { @IgnoredOnParcel
    override val displayNameId = R.string.Spring }
    @Parcelize @Serializable data object AUTUMN : YearSezon { @IgnoredOnParcel
...
sealed interface MusicGenre : GridGenreItem {
    @Parcelize @Serializable data object Rock : MusicGenre { @IgnoredOnParcel
    override val displayNameId = R.string.Rock; @IgnoredOnParcel
    override val colorHex = "#E53935" }
    @Parcelize @Serializable data object Jazz : MusicGenre { @IgnoredOnParcel
    override val displayNameId = R.string.Jazz; @IgnoredOnParcel
    override val colorHex = "#FFC107" }
    @Parcelize @Serializable data object LoFi : MusicGenre { @IgnoredOnParcel
    override val displayNameId = R.string.LoFi; @IgnoredOnParcel
    override val colorHex = "#B39DDB" }
    @Parcelize @Serializable data object Pop : MusicGenre { @IgnoredOnParcel
    override val displayNameId = R.string.Pop; @IgnoredOnParcel
    override val colorHex = "#FF4081" }
    @Parcelize @Serializable data object Classical : MusicGenre { @IgnoredOnParcel
    override val displayNameId = R.string.Classical; @IgnoredOnParcel
    override val colorHex = "#F5F5DC" }
    @Parcelize @Serializable data object Metal : MusicGenre { @IgnoredOnParcel
    override val displayNameId = R.string.Metal; @IgnoredOnParcel
    override val colorHex = "#212121" }
    @Parcelize @Serializable data object Electronic : MusicGenre { @IgnoredOnParcel
    override val displayNameId = R.string.Electronic; @IgnoredOnParcel
    override val colorHex = "#00E5FF" }
    @Parcelize @Serializable data object HipHop : MusicGenre { @IgnoredOnParcel
    override val displayNameId = R.string.HipHop; @IgnoredOnParcel
    override val colorHex = "#FB8C00" }
    @Parcelize @Serializable data object Country : MusicGenre { @IgnoredOnParcel
    override val displayNameId = R.string.Country; @IgnoredOnParcel
    override val colorHex = "#8D6E63" }
    @Parcelize @Serializable data object Ambient : MusicGenre { @IgnoredOnParcel
    override val displayNameId = R.string.Ambient; @IgnoredOnParcel
...
sealed interface ObjectData {
    ...
    fun copyWithIdAndPositionAndLink(id: Long, position: Int, link: LinkData) : ObjectData
    ...
    data class Carousel(
        ...
        override fun copyWithIdAndPositionAndLink(id: Long, position: Int, link: LinkData) : ObjectData {
            return copy(id = id, position = position, link = link)
        }
    }
